...
{
    public static class TC_SchemaSet_Add_SchemaSet
    {
        //-----------------------------------------------------------------------------------
        [Fact]
        ...
        public static void v1()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => sc.Add((XmlSchemaSet)null));
        }
        ...
        public static void v9()
        {
            ...
            scnew.Add(null, TestData._XsdAuthorDup); // this conflicts with _XsdAuthor
            scnew.Compile();
            Assert.Throws<XmlSchemaException>(() => sc.Add(scnew));
        }
        ...
        public static void v10()
        {
            ...
            Assert.Throws<XmlSchemaException>(() => schemaSet2.Add(schemaSet1));
