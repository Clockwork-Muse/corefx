...
{
    public static class IsEvenTests
    {
        ...
        public static void RunIsEvenTests()
        {
            ...
            {
                string bigInt1 = Utils.BuildRandomNumber(random.Next() % MaxDigits + 1, random.Next());
            ...
            for (int i = 0; i < Reps; i++)
            {
                string bigInt2 = Utils.BuildRandomNumber(random.Next() % MaxDigits + 1, random.Next());
