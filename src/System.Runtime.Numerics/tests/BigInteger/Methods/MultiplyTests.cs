...
namespace System.Numerics.Tests
{
    public static class MultiplyTests
    {
        ...
        public static void RunMultiply_TwoLargeBigIntegers_Threshold()
        {
            ...
            Utils.RunWithFakeThreshold("SquareThreshold", 8, () =>
                Utils.RunWithFakeThreshold("MultiplyThreshold", 8, RunMultiply_TwoLargeBigIntegers)
            );

            // Again, with lower threshold
            Utils.RunWithFakeThreshold("SquareThreshold", 8, () =>
                Utils.RunWithFakeThreshold("MultiplyThreshold", 8, () =>
                    Utils.RunWithFakeThreshold("AllocationThreshold", 8, RunMultiply_TwoLargeBigIntegers)
                )
            );
        }
