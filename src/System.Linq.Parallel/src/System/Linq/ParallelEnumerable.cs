...
namespace System.Linq
{
    ...
    public static class ParallelEnumerable
    {
        ...
        //-----------------------------------------------------------------------------------
        // MinBy retrieves the minimum element as compared with the given key.
        //

        /// <summary>
        /// Examines in parallel the elements of a sequence, and retrieves the minimum value according to a key.
        /// </summary>
        /// <remarks>
        /// In contrast to the sequential implementation, this does not return a stable result.
        /// See the remarks for MinBy(ParallelQuery{TSource}, Func{TSource,TKey}, IComparer{TKey}) for
        ...
        /// <param name="source">A sequence of values to order.</param>
        /// <param name="keySelector">A function to extract a key from an element.</param>
        /// <returns>The minimum value of the sequence, as ordered by the extracted key.</returns>
        /// <exception cref="T:System.ArgumentNullException">
        /// <paramref name="source"/> or <paramref name="keySelector"/> is a null reference (Nothing in Visual Basic).
        /// </exception>
        ...
        /// <code>var ordered = source.MinBy((e) => e.k);</code>
        /// to instead be formed as:
        /// <code>var ordered = source.Select((e,i) => new KeyValuePair{E, int}(e, i)).MinBy(kv => kv, customComparer).e;</code>,
        ...
        /// </remarks>
        [Obsolete(RIGHT_SOURCE_NOT_PARALLEL_STR)]
        public static ParallelQuery<TSource> Union<TSource, TKey>(
        ...
        /// <summary>
        /// Produces the set union of two parallel sequences by using a specified IEquatable{T} key.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of the input sequences.</typeparam>
        ...
        /// </remarks>
        [Obsolete(RIGHT_SOURCE_NOT_PARALLEL_STR)]
        public static ParallelQuery<TSource> Except<TSource, TKey>(
            this ParallelQuery<TSource> first, IEnumerable<TSource> second, Func<TSource, TKey> third)
        {
            throw new NotSupportedException(SR.ParallelEnumerable_BinaryOpMustUseAsParallel);
        }
        ...
        /// specified IEquatable{T} to compare keys.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of the input sequences.</typeparam>
        /// <typeparam name="TKey">The type of the extracted keys.</typeparam>
        ...
        /// </param>
        /// <param name="predicate">A predicate returning a key.</param>
        /// <returns>A sequence that contains the set difference of the elements of two sequences as keyed by the predicate.</returns>
        /// <exception cref="T:System.ArgumentNullException">
        /// <paramref name="first"/> or <paramref name="second"/> or <paramref name="predicate"/> is a null reference (Nothing in Visual Basic).
        /// </exception>
        public static ParallelQuery<TSource> Except<TSource, TKey>(
